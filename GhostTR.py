...
# “O people who believe! Do not consume your neighbor's wealth in a false way," (QS. An Nisaa': 29). The Prophet SAW also forbade his people to take the rights of others without permission.
...
Bl = '\033[30m'  # VARIABLE FOR CUYY COLORS
Re = '\033[1;31m'
Gr = '\033[1;32m'
Ye = '\033[1;33m'
Blu = '\033[1;34m'
...
def phoneGW():
    User_phone = input(
        f"\n {Wh}Enter phone number target {Gr}Ex [+880xxxxxxxxxx] {Wh}: {Gr}")  # INPUT NUMBER PHONE
    default_region = "ID"  # DEFAULT BANGLADESHI
...
def option():
    ...
    / /_/ / / / / /_/ (__  ) /_/_____/ / / /  / /_/ / /__/ ,<   
    \____/_/ /_/\____/____/\__/     /_/ /_/   \__,_/\___/_/|_| V.03

               {Wh} [ + ]  CODE BY TEAM BD CYBER NINJA           [ + ]
                [ + ]  WE ARE EVERYWHERE ARE SPY AGENTS      [ + ]
                [ + ]  WE MAKE A PEACE-JUSTICE-TAWHID        [ + ]
                [ + ]  WE ARE MUSLIM BLACK HAT-HACKER TEAM   [ + ]
    """)
...
def run_banner():
    ...
    stderr.writelines(f"""{Wh}
         .-.
       .'   `.          {Wh}--------------------------------
       :g g   :         {Wh}| {Gr}GHOST - IP ADDRESS - TRACKER {Wh}|
       : o    `.        {Wh}| {Gr} @CODE BY ZEROX UCHIHA       {Wh}|
      :         ``.     {Wh}--------------------------------
     :             `.
    :  :         .   `.
    :   :          ` . `.
